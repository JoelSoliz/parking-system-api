...
from schemas.administrator import CreateAdministrator, Administrator
...
@administrator_router.post('/register', response_model=CreateAdministrator, tags=['Administrator'])
def register_administrator(administrator: CreateAdministrator = Depends(),
