...
Revision ID: 7618821bd8b1
Revises: 
Create Date: 2023-06-22 01:16:01.670536
...
def upgrade() -> None:
    ...
    sa.Column('openning_time', sa.Time(), nullable=False),
    sa.Column('clousing_time', sa.Time(), nullable=False),
    ...
    sa.Column('type_spot', sa.String(length=4), nullable=True),
    sa.ForeignKeyConstraint(['type_spot'], ['parking_type.id_spot_type'], ),
    ...
    sa.Column('request', sa.String(length=125), nullable=False),
    ...
    sa.Column('reservation', sa.String(length=4), nullable=True),
    sa.ForeignKeyConstraint(['reservation'], ['reservation.id_reservation'], ),
    ...
    sa.Column('assisted_by', sa.String(length=4), nullable=True),
    sa.Column('assisted_datetime', sa.DateTime(), nullable=True),
